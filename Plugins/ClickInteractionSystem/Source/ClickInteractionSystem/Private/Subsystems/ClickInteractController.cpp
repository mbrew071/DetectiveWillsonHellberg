...
bool UClickInteractController::InitializePlugin(TSoftClassPtr<UInteractActions> InInteractActions, TSoftClassPtr<UUserWidget> InDefaultWidget, FGameplayTag InInteractComponent, FGameplayTag InRangeArea, FGameplayTag InOverlapTarget) 
{
	bool bSuccess = true;
